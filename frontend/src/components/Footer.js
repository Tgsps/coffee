      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="mb-6">
              <span className="font-serif text-3xl font-bold tracking-tight">21<img src="https://i.ibb.co/bgndCPCv/72818780-d3ba-4367-b620-58e55790f53d.png" alt="coffee icon" className="inline-block w-5 h-5 mx-1 align-middle" referrerPolicy="no-referrer" />coffee</span>
            </div>
